...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        if AUTH_CHANNEL and not await is_subscribed(client, query):
            await query.answer("മോനെ {query.from_user.first_name} നീ കൂടുതൽ സ്മാർട്ട്‌ ആവാൻ നോക്കണ്ട ആദ്യം ഗ്രൂപ്പിൽ ജോയിൻ ചെയ്യ്\n{query.from_user.first_name} I Like Your Smartness, But Don't Be Oversmart 😒", show_alert=True)
            return
        ident, file_id = query.data.split("#")
        files_ = await get_file_details(file_id)
        if not files_:
...
async def auto_filter(client, msg, spoll=False):
    ...
    if imdb:
        ...
        cap = f"<b>🎪 ᴛɪᴛɪʟᴇ {search}\n\n┏ 🤴 ᴀsᴋᴇᴅ ʙʏ : {message.from_user.mention}\n┣ ⚡ ᴘᴏᴡᴇʀᴇᴅ ʙʏ : [ʀᴏʟᴇx²ᵒ](https://t.me/Ramananv4_bot)\n┗ 🍁 ᴄʜᴀɴɴᴇʟ : [ᴍᴏᴠɪᴇ ʙᴏꜱꜱ](https://t.me/MovieBoss4)\n\nᴀꜰᴛᴇʀ 30 ᴍɪɴᴜᴛᴇꜱ ᴛʜɪꜱ ᴍᴇꜱꜱᴀɢᴇ ᴡɪʟʟ ʙᴇ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴅᴇʟᴇᴛᴇᴅ\n\n<i>★ ᴘᴏᴡᴇʀᴇᴅ ʙʏ  [ᴍᴏᴠɪᴇ ʙᴏꜱꜱ](https://t.me/MovieBoss4)</i></b>"
    if imdb and imdb.get('poster'):
        try:
            ...
            logger.exception(e)
            await message.reply_photo(photo='https://telegra.ph/file/d16af6783a0719f07878a.jpg', caption=cap, reply_markup=InlineKeyboardMarkup(btn))
    else:
        await message.reply_photo(photo='https://telegra.ph/file/d16af6783a0719f07878a.jpg', caption=cap, reply_markup=InlineKeyboardMarkup(btn))
    if spoll:
